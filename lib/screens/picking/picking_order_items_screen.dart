...
import 'picking_batch_scanner_screen.dart';

class PickingOrderItemsScreen extends StatefulWidget {
  final int manifestoId;
  final String manifestoDisplay;

  const PickingOrderItemsScreen({
    super.key,
  ...
  @override
  State<PickingOrderItemsScreen> createState() =>
      _PickingOrderItemsScreenState();
}

class _PickingOrderItemsScreenState extends State<PickingOrderItemsScreen> {
  ...
  Future<void> _openBatchScanner(List<OrderItemModel> items) async {
    final result = await Navigator.push<bool>(
      context,
      MaterialPageRoute(
        builder: (_) => PickingBatchScannerScreen(items: items),
      ),
    );
