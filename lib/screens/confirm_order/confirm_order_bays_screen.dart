...
import 'confirm_order_items_screen.dart';

class ConfirmOrderBaysScreen extends StatefulWidget {
  final DateTime selectedDate;

  const ConfirmOrderBaysScreen({super.key, required this.selectedDate});

  @override
  State<ConfirmOrderBaysScreen> createState() => _ConfirmOrderBaysScreenState();
}

class _ConfirmOrderBaysScreenState extends State<ConfirmOrderBaysScreen> {
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ConfirmOrderItemsScreen(
